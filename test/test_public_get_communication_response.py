...
class TestPublicGetCommunicationResponse(unittest.TestCase):
    """PublicGetCommunicationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PublicGetCommunicationResponse:
        """Test PublicGetCommunicationResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PublicGetCommunicationResponse`
        """
        model = PublicGetCommunicationResponse()
        if include_optional:
            return PublicGetCommunicationResponse(
    ...
    def testPublicGetCommunicationResponse(self):
        """Test PublicGetCommunicationResponse"""
