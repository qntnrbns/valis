...
class TestLegislationTextGetResponse(unittest.TestCase):
    """LegislationTextGetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LegislationTextGetResponse:
        """Test LegislationTextGetResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LegislationTextGetResponse`
        """
        model = LegislationTextGetResponse()
        if include_optional:
            return LegislationTextGetResponse(
    ...
    def testLegislationTextGetResponse(self):
        """Test LegislationTextGetResponse"""
