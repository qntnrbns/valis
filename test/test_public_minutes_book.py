...
class TestPublicMinutesBook(unittest.TestCase):
    """PublicMinutesBook unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PublicMinutesBook:
        """Test PublicMinutesBook
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PublicMinutesBook`
        """
        model = PublicMinutesBook()
        if include_optional:
            return PublicMinutesBook(
                vote_room_id = 56,
                session_name = '',
                session_code = '',
                session_id = 56,
    ...
    def testPublicMinutesBook(self):
        """Test PublicMinutesBook"""
