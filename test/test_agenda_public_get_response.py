...
class TestAgendaPublicGetResponse(unittest.TestCase):
    """AgendaPublicGetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AgendaPublicGetResponse:
        """Test AgendaPublicGetResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AgendaPublicGetResponse`
        """
        model = AgendaPublicGetResponse()
        if include_optional:
            return AgendaPublicGetResponse(
                sequence = 56,
    ...
    def testAgendaPublicGetResponse(self):
        """Test AgendaPublicGetResponse"""
