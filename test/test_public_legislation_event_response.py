...
class TestPublicLegislationEventResponse(unittest.TestCase):
    """PublicLegislationEventResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PublicLegislationEventResponse:
        """Test PublicLegislationEventResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PublicLegislationEventResponse`
        """
        model = PublicLegislationEventResponse()
        if include_optional:
            return PublicLegislationEventResponse(
    ...
    def testPublicLegislationEventResponse(self):
        """Test PublicLegislationEventResponse"""
