...
class TestCalendarsPublicGetResponse(unittest.TestCase):
    """CalendarsPublicGetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarsPublicGetResponse:
        """Test CalendarsPublicGetResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarsPublicGetResponse`
        """
        model = CalendarsPublicGetResponse()
        if include_optional:
            return CalendarsPublicGetResponse(
                success = True,
                failure_message = '',
                cache_key_name = '',
                list_items = [
                    valis.models.calendar_public_get_response.CalendarPublicGetResponse(
    ...
    def testCalendarsPublicGetResponse(self):
        """Test CalendarsPublicGetResponse"""
