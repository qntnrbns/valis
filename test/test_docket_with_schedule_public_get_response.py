...
class TestDocketWithSchedulePublicGetResponse(unittest.TestCase):
    """DocketWithSchedulePublicGetResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocketWithSchedulePublicGetResponse:
        """Test DocketWithSchedulePublicGetResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocketWithSchedulePublicGetResponse`
        """
        model = DocketWithSchedulePublicGetResponse()
        if include_optional:
            return DocketWithSchedulePublicGetResponse(
    ...
    def testDocketWithSchedulePublicGetResponse(self):
        """Test DocketWithSchedulePublicGetResponse"""
