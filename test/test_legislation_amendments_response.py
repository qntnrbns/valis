...
class TestLegislationAmendmentsResponse(unittest.TestCase):
    """LegislationAmendmentsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LegislationAmendmentsResponse:
        """Test LegislationAmendmentsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LegislationAmendmentsResponse`
        """
        model = LegislationAmendmentsResponse()
        if include_optional:
            return LegislationAmendmentsResponse(
                success = True,
                failure_message = '',
                cache_key_name = '',
                list_items = [
                    valis.models.legislation_amendment_response.LegislationAmendmentResponse(
                        session_id = 56, 
                        session_code = '', 
    ...
    def testLegislationAmendmentsResponse(self):
        """Test LegislationAmendmentsResponse"""
