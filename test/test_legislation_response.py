...
class TestLegislationResponse(unittest.TestCase):
    """LegislationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LegislationResponse:
        """Test LegislationResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LegislationResponse`
        """
        model = LegislationResponse()
        if include_optional:
    ...
    def testLegislationResponse(self):
        """Test LegislationResponse"""
