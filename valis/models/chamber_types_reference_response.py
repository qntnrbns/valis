...
class ChamberTypesReferenceResponse(BaseModel):
    """
    List of Chambers
    """ # noqa: E501
    ...
    list_items: Optional[List[ChamberTypeReferenceResponse]] = Field(default=None, description="List of Chambers", alias="ListItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ListItems": [ChamberTypeReferenceResponse.from_dict(_item) for _item in obj["ListItems"]] if obj.get("ListItems") is not None else None
        })
        return _obj
