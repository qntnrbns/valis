...
class DocketFilePartnerGetResponse(BaseModel):
    """
    Docket File
    """ # noqa: E501
    ...
    modification_date: Optional[datetime] = Field(default=None, description="last modification date, needed to control updates", alias="ModificationDate")
    __properties: ClassVar[List[str]] = ["CalendarFileID", "CalendarID", "FileURL", "TextFormatID", "IsGenerated", "IsPublic", "IsActive", "ModificationDate"]
