...
class AgenciesResponse(BaseModel):
    ...
    list_items: Optional[List[AgencyResponse]] = Field(default=None, description="list of agencies", alias="ListItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ListItems": [AgencyResponse.from_dict(_item) for _item in obj["ListItems"]] if obj.get("ListItems") is not None else None
        })
        return _obj
