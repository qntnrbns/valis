...
class LegislationReferencesResponse(BaseModel):
    """
    ...
    name: Optional[StrictStr] = Field(default=None, description="Legislation Status Common Name", alias="Name")
    display_name: Optional[StrictStr] = Field(default=None, description="Legislation Status Display Name", alias="DisplayName")
    legislation_version_id: Optional[StrictInt] = Field(default=None, description="Unique Identifier for Legislation Version", alias="LegislationVersionID")
    __properties: ClassVar[List[str]] = ["LegislationStatusID", "Name", "DisplayName", "LegislationVersionID"]
