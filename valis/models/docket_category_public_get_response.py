...
class DocketCategoryPublicGetResponse(BaseModel):
    """
    ...
    calendar_category_id: StrictInt = Field(description="Calendar Category unique identifier", alias="CalendarCategoryID")
    docket_items: Optional[List[DocketItemPublicGetResponse]] = Field(default=None, description="Listing of Docket Items", alias="DocketItems")
    __properties: ClassVar[List[str]] = ["CalendarID", "CalendarCategoryTypeID", "CategoryCode", "CategoryType", "Description", "PluralDescription", "Sequence", "DisplayType", "IsLegislationCategory", "IsPrint", "CalendarCategoryID", "DocketItems"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in docket_items (list)
        _items = []
        if self.docket_items:
            for _item_docket_items in self.docket_items:
                if _item_docket_items:
                    _items.append(_item_docket_items.to_dict())
            _dict['DocketItems'] = _items
        ...
        # set to None if docket_items (nullable) is None
        # and model_fields_set contains the field
        if self.docket_items is None and "docket_items" in self.model_fields_set:
            _dict['DocketItems'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "DocketItems": [DocketItemPublicGetResponse.from_dict(_item) for _item in obj["DocketItems"]] if obj.get("DocketItems") is not None else None
        })
        return _obj
