...
class PublicMinutesSummary(BaseModel):
    """
    Public Minutes Summary, child of MinutesEntry
    """ # noqa: E501
    minutes_entry_id: Optional[StrictInt] = Field(default=None, description="unique reference identifier for Minutes Entry", alias="MinutesEntryID")
    minutes_summary: Optional[StrictStr] = Field(default=None, description="Minutes Summary", alias="MinutesSummary")
    __properties: ClassVar[List[str]] = ["MinutesEntryID", "MinutesSummary"]
