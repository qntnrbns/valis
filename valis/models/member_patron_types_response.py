...
class MemberPatronTypesResponse(BaseModel):
    """
    ...
    list_items: Optional[List[MemberPatronTypeResponse]] = Field(default=None, description="list of member patron types", alias="ListItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ListItems": [MemberPatronTypeResponse.from_dict(_item) for _item in obj["ListItems"]] if obj.get("ListItems") is not None else None
        })
        return _obj
