...
class PublicLegislationEventsResponse(BaseModel):
    """
    ...
    legislation_events: Optional[List[PublicLegislationEventResponse]] = Field(default=None, description="List of public Legislation Events", alias="LegislationEvents")
    __properties: ClassVar[List[str]] = ["Success", "FailureMessage", "CacheKeyName", "LegislationEvents"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in legislation_events (list)
        _items = []
        if self.legislation_events:
            for _item_legislation_events in self.legislation_events:
                if _item_legislation_events:
                    _items.append(_item_legislation_events.to_dict())
            _dict['LegislationEvents'] = _items
        ...
        # set to None if legislation_events (nullable) is None
        # and model_fields_set contains the field
        if self.legislation_events is None and "legislation_events" in self.model_fields_set:
            _dict['LegislationEvents'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "LegislationEvents": [PublicLegislationEventResponse.from_dict(_item) for _item in obj["LegislationEvents"]] if obj.get("LegislationEvents") is not None else None
        })
        return _obj
