...
class LegislationID(BaseModel):
    """
    Used to separate out legislation IDs
    """ # noqa: E501
    legislation_id: Optional[StrictInt] = Field(default=None, description="LegislationID", alias="LegislationId")
    __properties: ClassVar[List[str]] = ["LegislationId"]
