...
class StaffRoleTypes(BaseModel):
    """
    Staff Role Types
    """ # noqa: E501
    ...
    list_items: Optional[List[StaffRoleType]] = Field(default=None, description="list of Staff Role Types", alias="ListItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ListItems": [StaffRoleType.from_dict(_item) for _item in obj["ListItems"]] if obj.get("ListItems") is not None else None
        })
        return _obj
