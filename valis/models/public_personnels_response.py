...
class PublicPersonnelsResponse(BaseModel):
    """
    ...
    personnels: Optional[List[PublicPersonnelResponse]] = Field(default=None, description="List of Public Personnel", alias="Personnels")
    __properties: ClassVar[List[str]] = ["Success", "FailureMessage", "CacheKeyName", "Personnels"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in personnels (list)
        _items = []
        if self.personnels:
            for _item_personnels in self.personnels:
                if _item_personnels:
                    _items.append(_item_personnels.to_dict())
            _dict['Personnels'] = _items
        ...
        # set to None if personnels (nullable) is None
        # and model_fields_set contains the field
        if self.personnels is None and "personnels" in self.model_fields_set:
            _dict['Personnels'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Personnels": [PublicPersonnelResponse.from_dict(_item) for _item in obj["Personnels"]] if obj.get("Personnels") is not None else None
        })
        return _obj
