...
class MembersByCommitteeSearchResponse(BaseModel):
    """
    ...
    list_items: Optional[List[MemberByCommitteeSearchResponse]] = Field(default=None, description="Search list of Members by Committee", alias="ListItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ListItems": [MemberByCommitteeSearchResponse.from_dict(_item) for _item in obj["ListItems"]] if obj.get("ListItems") is not None else None
        })
        return _obj
