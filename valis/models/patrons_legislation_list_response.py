...
class PatronsLegislationListResponse(BaseModel):
    """
    ...
    list_items: Optional[List[PatronLegislationListResponse]] = Field(default=None, description="list of patron legislation", alias="ListItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ListItems": [PatronLegislationListResponse.from_dict(_item) for _item in obj["ListItems"]] if obj.get("ListItems") is not None else None
        })
        return _obj
