...
class MemberStatusTypeReferenceResponse(BaseModel):
    """
    ...
    name: Optional[Annotated[str, Field(strict=True, max_length=25)]] = Field(default=None, description="Member Status name", alias="Name")
    __properties: ClassVar[List[str]] = ["MemberStatusID", "Name"]
