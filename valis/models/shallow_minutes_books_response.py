...
class ShallowMinutesBooksResponse(BaseModel):
    """
    ...
    list_items: Optional[List[ShallowMinuteBookResponse]] = Field(default=None, description="List of MinutesBooks", alias="ListItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ListItems": [ShallowMinuteBookResponse.from_dict(_item) for _item in obj["ListItems"]] if obj.get("ListItems") is not None else None
        })
        return _obj
