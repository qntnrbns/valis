...
class VoteLinksResponse(BaseModel):
    """
    List of Vote Links
    """ # noqa: E501
    ...
    list_items: Optional[List[VoteLinkResponse]] = Field(default=None, description="list of Vote Links", alias="ListItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ListItems": [VoteLinkResponse.from_dict(_item) for _item in obj["ListItems"]] if obj.get("ListItems") is not None else None
        })
        return _obj
