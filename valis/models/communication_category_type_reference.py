...
class CommunicationCategoryTypeReference(BaseModel):
    """
    ...
    description: Optional[Annotated[str, Field(strict=True, max_length=10)]] = Field(default=None, description="Category description", alias="Description")
    ...
    __properties: ClassVar[List[str]] = ["CommunicationCategoryTypeID", "CategoryCode", "Description", "PluralDescription", "ChamberCode", "Sequence"]
