...
class OwnerTypesReferenceResponse(BaseModel):
    """
    List of Owner Types
    """ # noqa: E501
    ...
    list_items: Optional[List[OwnerTypeReferenceResponse1]] = Field(default=None, description="list of Owner Types", alias="ListItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ListItems": [OwnerTypeReferenceResponse1.from_dict(_item) for _item in obj["ListItems"]] if obj.get("ListItems") is not None else None
        })
        return _obj
