...
class SummaryVersionResponse(BaseModel):
    ...
    """ # noqa: E501
    summary_version_id: Optional[StrictInt] = Field(default=None, description="Summary Version unique identifier", alias="SummaryVersionID")
    name: Optional[StrictStr] = Field(default=None, description="Summary Version name", alias="Name")
    version_code: Optional[StrictStr] = Field(default=None, description="Version Code", alias="VersionCode")
    __properties: ClassVar[List[str]] = ["SummaryVersionID", "Name", "VersionCode"]
