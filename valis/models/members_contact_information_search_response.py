...
class MembersContactInformationSearchResponse(BaseModel):
    """
    ...
    list_items: Optional[List[MemberContactInformationSearchResponse]] = Field(default=None, description="List of Member Contact Information", alias="ListItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ListItems": [MemberContactInformationSearchResponse.from_dict(_item) for _item in obj["ListItems"]] if obj.get("ListItems") is not None else None
        })
        return _obj
