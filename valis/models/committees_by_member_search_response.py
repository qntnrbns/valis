...
class CommitteesByMemberSearchResponse(BaseModel):
    """
    ...
    list_items: Optional[List[CommitteeByMemberResponse]] = Field(default=None, description="List of committees associated to a member", alias="ListItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ListItems": [CommitteeByMemberResponse.from_dict(_item) for _item in obj["ListItems"]] if obj.get("ListItems") is not None else None
        })
        return _obj
