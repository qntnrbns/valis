...
class SponsorTypeResponse(BaseModel):
    """
    Sponsor type
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Body that can sponsor a Legislation Text (House/Senate/Conference/Governor)", alias="Name")
    ...
    __properties: ClassVar[List[str]] = ["Name", "SponsorTypeID"]
