...
class CalendarTypesResponse(BaseModel):
    """
    ...
    list_items: Optional[List[CalendarTypeResponse]] = Field(default=None, description="list of Calendar Actions", alias="ListItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ListItems": [CalendarTypeResponse.from_dict(_item) for _item in obj["ListItems"]] if obj.get("ListItems") is not None else None
        })
        return _obj
