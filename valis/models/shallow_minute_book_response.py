...
class ShallowMinuteBookResponse(BaseModel):
    """
    ...
    minutes_book_id: Optional[StrictInt] = Field(default=None, description="Unique identifier for MinutesBook", alias="MinutesBookID")
    status: Optional[Annotated[str, Field(strict=True, max_length=100)]] = Field(default=None, description="MinutesBook Status (e.g. Pending/Published)", alias="Status")
    pending_change: Optional[StrictBool] = Field(default=None, description="Are there any pending changes?", alias="PendingChange")
    minutes_calendars: Optional[List[PublicMinutesCalendar]] = Field(default=None, description="List of Minutes Calendars", alias="MinutesCalendars")
    minutes_files: Optional[List[PublicMinutesFile]] = Field(default=None, description="List of Minutes Files", alias="MinutesFiles")
    __properties: ClassVar[List[str]] = ["VoteRoomID", "SessionName", "SessionCode", "SessionID", "CommitteeID", "CommitteeName", "ChamberCode", "MinutesDate", "MinutesNumber", "MinutesStatusID", "MinutesStatus", "MinutesBookID", "Status", "PendingChange", "MinutesCalendars", "MinutesFiles"]
