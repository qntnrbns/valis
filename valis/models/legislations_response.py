...
class LegislationsResponse(BaseModel):
    """
    ...
    list_items: Optional[List[LegislationResponse]] = Field(default=None, description="list of legislation", alias="ListItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ListItems": [LegislationResponse.from_dict(_item) for _item in obj["ListItems"]] if obj.get("ListItems") is not None else None,
