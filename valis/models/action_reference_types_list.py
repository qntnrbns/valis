...
class ActionReferenceTypesList(BaseModel):
    """
    ...
    list_items: Optional[List[ActionReferenceTypeList]] = Field(default=None, description="list of Actions Reference Types", alias="ListItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ListItems": [ActionReferenceTypeList.from_dict(_item) for _item in obj["ListItems"]] if obj.get("ListItems") is not None else None
        })
        return _obj
