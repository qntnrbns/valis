...
class LegislationTextActionResponse(BaseModel):
    """
    building element for legislation action list
    """ # noqa: E501
    legislation_text_action_id: Optional[StrictInt] = Field(default=None, description="unique identifier of the LegislationTextAction", alias="LegislationTextActionID")
    ...
    __properties: ClassVar[List[str]] = ["LegislationTextActionID", "Description", "EventCode"]
