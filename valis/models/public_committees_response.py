...
class PublicCommitteesResponse(BaseModel):
    """
    ...
    list_items: Optional[List[PublicCommitteeResponse]] = Field(default=None, description="List of Public Committees", alias="ListItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ListItems": [PublicCommitteeResponse.from_dict(_item) for _item in obj["ListItems"]] if obj.get("ListItems") is not None else None
        })
        return _obj
