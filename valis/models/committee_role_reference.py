...
class CommitteeRoleReference(BaseModel):
    """
    Information for a Committee Role
    """ # noqa: E501
    committee_role_id: Optional[StrictInt] = Field(default=None, description="Unique identifier for this Committee Role", alias="CommitteeRoleID")
    title: Optional[Annotated[str, Field(strict=True, max_length=25)]] = Field(default=None, description="Role title", alias="Title")
    ...
    __properties: ClassVar[List[str]] = ["CommitteeRoleID", "Title", "ChamberCode"]
