...
class LegislationTextDraftsResponse(BaseModel):
    """
    ...
    list_items: Optional[List[LegislationTextDraftResponse]] = Field(default=None, description="list of text drafts", alias="ListItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ListItems": [LegislationTextDraftResponse.from_dict(_item) for _item in obj["ListItems"]] if obj.get("ListItems") is not None else None
        })
        return _obj
