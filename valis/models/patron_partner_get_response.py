...
class PatronPartnerGetResponse(BaseModel):
    """
    ...
    by_request: Optional[StrictBool] = Field(default=None, description="Is this draft by request of a state agency or entity ?", alias="ByRequest")
