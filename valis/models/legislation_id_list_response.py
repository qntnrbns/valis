...
class LegislationIdListResponse(BaseModel):
    """
    ...
    search_text: Optional[List[LegislationSearchText]] = Field(default=None, description="List of Search Text (contains version results)", alias="SearchText")
    __properties: ClassVar[List[str]] = ["LegislationID", "LegislationStatusID", "LegislationNumber", "SessionID", "SessionCode", "SearchText"]
