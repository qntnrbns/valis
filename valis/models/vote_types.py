...
class VoteTypes(BaseModel):
    ...
    list_items: Optional[List[VoteType]] = Field(default=None, description="List of Vote Types", alias="ListItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ListItems": [VoteType.from_dict(_item) for _item in obj["ListItems"]] if obj.get("ListItems") is not None else None
        })
        return _obj
