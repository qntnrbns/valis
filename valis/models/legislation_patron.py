...
class LegislationPatron(BaseModel):
    """
    LegislationPatron
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["LegislationID", "LegislationTextID", "ChamberCode", "MemberID", "MemberNumber", "PatronTypeID", "Name", "DisplayName", "MemberDisplayName", "PatronDisplayName", "Sequence", "ByRequest"]
