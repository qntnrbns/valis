...
class PublicVoteFile(BaseModel):
    """
    ...
    text_format_id: Optional[StrictStr] = Field(default=None, description="Unique identifier for Text Format", alias="TextFormatID")
    is_generated: Optional[StrictBool] = Field(default=None, description="Has the file been generated yet?", alias="IsGenerated")
    is_active: Optional[StrictBool] = Field(default=None, description="is it active?", alias="IsActive")
    __properties: ClassVar[List[str]] = ["VoteFileID", "VoteID", "FileURL", "TextFormatID", "IsGenerated", "IsActive"]
