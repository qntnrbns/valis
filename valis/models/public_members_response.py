...
class PublicMembersResponse(BaseModel):
    ...
    list_items: Optional[List[PublicMemberResponse]] = Field(default=None, description="list of Public Members", alias="ListItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ListItems": [PublicMemberResponse.from_dict(_item) for _item in obj["ListItems"]] if obj.get("ListItems") is not None else None
        })
        return _obj
