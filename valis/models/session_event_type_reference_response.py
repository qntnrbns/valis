...
class SessionEventTypeReferenceResponse(BaseModel):
    """
    ...
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Description/Name of the ID", alias="Name")
    id: Optional[StrictInt] = Field(default=None, description="Session Event Type unique identifier", alias="ID")
