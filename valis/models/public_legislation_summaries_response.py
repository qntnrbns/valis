...
class PublicLegislationSummariesResponse(BaseModel):
    """
    ...
    list_items: Optional[List[PublicLegislationSummaryResponse]] = Field(default=None, description="list of persons", alias="ListItems")
    search_criteria: Optional[StrictStr] = Field(default=None, description="Search JSON used to product these results", alias="SearchCriteria")
    __properties: ClassVar[List[str]] = ["Success", "FailureMessage", "CacheKeyName", "ListItems", "SearchCriteria"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ListItems": [PublicLegislationSummaryResponse.from_dict(_item) for _item in obj["ListItems"]] if obj.get("ListItems") is not None else None,
