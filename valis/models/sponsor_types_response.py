...
class SponsorTypesResponse(BaseModel):
    """
    ...
    list_items: Optional[List[SponsorTypeResponse]] = Field(default=None, description="list of sponsor types", alias="ListItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ListItems": [SponsorTypeResponse.from_dict(_item) for _item in obj["ListItems"]] if obj.get("ListItems") is not None else None
        })
        return _obj
