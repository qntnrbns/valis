...
class LegislationsReferencesResponse(BaseModel):
    """
    ...
    list_items: Optional[List[LegislationReferencesResponse]] = Field(default=None, description="List of Legislation Statuses", alias="ListItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ListItems": [LegislationReferencesResponse.from_dict(_item) for _item in obj["ListItems"]] if obj.get("ListItems") is not None else None
        })
        return _obj
