...
class LegislationEventTypesReferenceResponse(BaseModel):
    """
    ...
    list_items: Optional[List[LegislationEventTypeReferenceResponse]] = Field(default=None, description="list of LegislationEventTypeReferenceResponse", alias="ListItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ListItems": [LegislationEventTypeReferenceResponse.from_dict(_item) for _item in obj["ListItems"]] if obj.get("ListItems") is not None else None
        })
        return _obj
