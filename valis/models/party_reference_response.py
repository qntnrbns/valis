...
class PartyReferenceResponse(BaseModel):
    ...
    """ # noqa: E501
    party_code: Optional[Annotated[str, Field(strict=True, max_length=1)]] = Field(default=None, description="Unique identifer for Political Party", alias="PartyCode")
    name: Optional[Annotated[str, Field(strict=True, max_length=25)]] = Field(default=None, description="Political Party name", alias="Name")
    __properties: ClassVar[List[str]] = ["PartyCode", "Name"]
