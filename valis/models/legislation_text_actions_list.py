...
class LegislationTextActionsList(BaseModel):
    """
    ...
    list_items: Optional[List[LegislationTextActionResponse]] = Field(default=None, description="list of Legislation Text Actions", alias="ListItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ListItems": [LegislationTextActionResponse.from_dict(_item) for _item in obj["ListItems"]] if obj.get("ListItems") is not None else None
        })
        return _obj
