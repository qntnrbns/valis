...
class ChamberStatisticsResponse(BaseModel):
    """
    ...
    list_items: Optional[List[ChamberStatisticResponse]] = Field(default=None, description="committee statistics list", alias="ListItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ListItems": [ChamberStatisticResponse.from_dict(_item) for _item in obj["ListItems"]] if obj.get("ListItems") is not None else None
        })
        return _obj
