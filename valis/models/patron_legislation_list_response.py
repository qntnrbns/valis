...
class PatronLegislationListResponse(BaseModel):
    """
    ...
    sequence: Optional[StrictInt] = Field(default=None, description="Patron Sequence # (e.g. 1001 ==> Chief Patron)", alias="Sequence")
    is_introducing: Optional[StrictBool] = Field(default=None, description="Is this patron introducing the bill?", alias="IsIntroducing")
    by_request: Optional[StrictBool] = Field(default=None, description="Is this by request of an entity?", alias="ByRequest")
    legislation: Optional[List[Legislation]] = Field(default=None, description="legislation", alias="Legislation")
    __properties: ClassVar[List[str]] = ["LegislationID", "LegislationTextID", "ChamberCode", "MemberID", "MemberNumber", "PatronTypeID", "Name", "DisplayName", "MemberDisplayName", "PatronDisplayName", "LegislationNumber", "Sequence", "IsIntroducing", "ByRequest", "Legislation"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in legislation (list)
        _items = []
        if self.legislation:
            for _item_legislation in self.legislation:
                if _item_legislation:
                    _items.append(_item_legislation.to_dict())
            _dict['Legislation'] = _items
        ...
        # set to None if is_introducing (nullable) is None
        # and model_fields_set contains the field
        if self.is_introducing is None and "is_introducing" in self.model_fields_set:
            _dict['IsIntroducing'] = None
        ...
        # set to None if legislation (nullable) is None
        # and model_fields_set contains the field
        if self.legislation is None and "legislation" in self.model_fields_set:
            _dict['Legislation'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "IsIntroducing": obj.get("IsIntroducing"),
            "ByRequest": obj.get("ByRequest"),
            "Legislation": [Legislation.from_dict(_item) for _item in obj["Legislation"]] if obj.get("Legislation") is not None else None
        })
        return _obj
