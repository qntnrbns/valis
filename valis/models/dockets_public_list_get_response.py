...
class DocketsPublicListGetResponse(BaseModel):
    """
    ...
    list_items: Optional[List[DocketPublicListGetResponse]] = Field(default=None, description="list of Dockets", alias="ListItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ListItems": [DocketPublicListGetResponse.from_dict(_item) for _item in obj["ListItems"]] if obj.get("ListItems") is not None else None
        })
        return _obj
