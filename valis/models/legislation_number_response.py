...
class LegislationNumberResponse(BaseModel):
    """
    Legislation Number Response
    """ # noqa: E501
    legislation_number: Optional[StrictStr] = Field(default=None, description="LegislationNumber", alias="LegislationNumber")
    __properties: ClassVar[List[str]] = ["LegislationNumber"]
