...
class LegislationsTextGetResponse(BaseModel):
    """
    ...
    list_items: Optional[List[LegislationTextGetResponse]] = Field(default=None, description="list of legislation summaries", alias="ListItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ListItems": [LegislationTextGetResponse.from_dict(_item) for _item in obj["ListItems"]] if obj.get("ListItems") is not None else None
        })
        return _obj
