...
class PatronBaseModel(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["LegislationID", "LegislationTextID", "ChamberCode", "MemberID", "MemberNumber", "PatronTypeID", "Name", "DisplayName", "MemberDisplayName", "PatronDisplayName"]
