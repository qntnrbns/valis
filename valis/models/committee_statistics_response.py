...
class CommitteeStatisticsResponse(BaseModel):
    ...
    list_items: Optional[List[CommitteeStatisticResponse]] = Field(default=None, description="committee statistics list", alias="ListItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ListItems": [CommitteeStatisticResponse.from_dict(_item) for _item in obj["ListItems"]] if obj.get("ListItems") is not None else None
        })
        return _obj
