...
class LegislationTextResponse(BaseModel):
    """
    Legislation Text Response
    """ # noqa: E501
    legislation_id: Optional[StrictInt] = Field(default=None, description="unique identifier for the Legislation", alias="LegislationID")
    legislation_number: Optional[StrictStr] = Field(default=None, description="Bill #", alias="LegislationNumber")
    description: Optional[StrictStr] = Field(default=None, description="Legislation Description", alias="Description")
    session_id: Optional[StrictInt] = Field(default=None, description="unique identifier for the Session", alias="SessionID")
    ...
    ld_number: Optional[StrictStr] = Field(default=None, description="Bill LD#", alias="LDNumber")
    legislation_version_id: Optional[StrictInt] = Field(default=None, description="unique identifier of LegislationVersion", alias="LegislationVersionID")
    version: Optional[StrictStr] = Field(default=None, description="Version", alias="Version")
    ...
    is_emergency: Optional[StrictBool] = Field(default=None, description="Is this text an emergency ?", alias="IsEmergency")
    is_reprint: Optional[StrictBool] = Field(default=None, description="Is this text Reprint ?", alias="IsReprint")
    text_disposition_id: Optional[StrictInt] = Field(default=None, description="Text Disposition ID", alias="TextDispositionID")
    __properties: ClassVar[List[str]] = ["LegislationID", "LegislationNumber", "Description", "SessionID", "LegislationTextID", "DraftDate", "DocumentCode", "LDNumber", "LegislationVersionID", "Version", "IsPublic", "IsComplete", "GovernorsRequest", "PDFFile", "HTMLFile", "ImpactFile", "LinkFile", "IsEmergency", "IsReprint", "TextDispositionID"]
