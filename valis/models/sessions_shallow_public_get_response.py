...
class SessionsShallowPublicGetResponse(BaseModel):
    """
    ...
    list_items: Optional[List[SessionShallowPublicGetResponse]] = Field(default=None, description="list of sessions", alias="ListItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ListItems": [SessionShallowPublicGetResponse.from_dict(_item) for _item in obj["ListItems"]] if obj.get("ListItems") is not None else None
        })
        return _obj
