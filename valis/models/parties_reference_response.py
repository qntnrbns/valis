...
class PartiesReferenceResponse(BaseModel):
    """
    ...
    list_items: Optional[List[PartyReferenceResponse]] = Field(default=None, description="list of Politcal Parties", alias="ListItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ListItems": [PartyReferenceResponse.from_dict(_item) for _item in obj["ListItems"]] if obj.get("ListItems") is not None else None
        })
        return _obj
