...
class ContactPublicGetResponse(BaseModel):
    """
    ...
    contact_type: Optional[Annotated[str, Field(strict=True, max_length=25)]] = Field(default=None, description="Contact Type description", alias="ContactType")
    ...
    contact_information_id: Optional[StrictInt] = Field(default=None, description="Contact unique identifier", alias="ContactInformationID")
    __properties: ClassVar[List[str]] = ["OwnerID", "ContactTypeID", "ContactType", "Address1", "Address2", "Address3", "City", "StateCode", "ZipCode", "PhoneNumber", "EmailAddress", "IsActive", "IsPublic", "ContactInformationID"]
