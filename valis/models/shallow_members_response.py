...
class ShallowMembersResponse(BaseModel):
    """
    ...
    list_items: Optional[List[ShallowMemberResponse]] = Field(default=None, description="List of shallow members", alias="ListItems")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ListItems": [ShallowMemberResponse.from_dict(_item) for _item in obj["ListItems"]] if obj.get("ListItems") is not None else None
        })
        return _obj
