...
class LegislationSearchText(BaseModel):
    """
    ...
    description: Optional[StrictStr] = Field(default=None, description="Legislation Version description", alias="Description")
    document_code: Optional[StrictStr] = Field(default=None, description="Legislation Document code", alias="DocumentCode")
    count_matches: Optional[StrictInt] = Field(default=None, description="Count of Keyword Matches", alias="countMatches")
    __properties: ClassVar[List[str]] = ["LegislationTextID", "Description", "DocumentCode", "countMatches"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "countMatches": obj.get("countMatches")
        })
        return _obj
